...
struct cm_store_entry {
	...
	enum cm_state {
		CM_INVALID,
		CM_NEED_KEY_PAIR, CM_NEED_KEY_GEN_PIN,
		CM_GENERATING_KEY_PAIR, CM_HAVE_KEY_PAIR,
		CM_NEED_CSR, CM_NEED_CSR_GEN_PIN, CM_GENERATING_CSR,
		...
		CM_NEED_GUIDANCE,
		CM_NEWLY_ADDED,
		CM_NEWLY_ADDED_READING_KEYI, CM_NEED_KEYINFO_READ_PIN,
